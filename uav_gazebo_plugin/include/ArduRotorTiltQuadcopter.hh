 ...
 *
*/
#ifndef GAZEBO_PLUGINS_ARDUPILOTTILTQUADCOPTER_HH_
#define GAZEBO_PLUGINS_ARDUPILOTTILTQUADCOPTER_HH_
...
class GAZEBO_VISIBLE ArduRotorTiltQuadcopter : public ModelPlugin {
    /// \brief Constructor.
public:
